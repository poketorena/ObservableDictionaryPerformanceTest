...
namespace ObservableDictionaryPerformanceTest.Collections.Generic
{
        ...
        : KeyedCollection<TKey, KeyValuePair<TKey, TValue>>, IDictionary<TKey, TValue>
    {
        ...
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> クラスの
        ///   新しいインスタンスを初期化します。
        /// </summary>
        ...
        ///   新しい <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> に要素がコピーされた 
        ...
        #region IDictionary<>
        /// <summary>
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> 内のキーを
        ///   格納しているコレクションを取得します。
        /// </summary>
        ...
        /// <summary>
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> 内の値を
        ///   格納しているコレクションを取得します。
        /// </summary>
        ...
        /// </exception>
        /// <exception cref="T:System.ArgumentException">
        ///   同じキーを持つ要素が、<see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> に既に存在します。
        /// </exception>
        ...
        /// <summary>
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> に特定の値が格納されているかどうかを判断します。
        /// </summary>
        /// <returns>
        ///   指定した値を持つ要素が <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> に格納されている場合は true。
        ///   それ以外の場合は false。
        /// </returns>
        /// <param name="key">
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> 内で検索される値。
        ...
        /// </summary>
        /// <returns>
        ///   指定したキーを持つ要素が <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.CollectionBasedDictionary`2" /> に格納されている場合は true。
        ///   それ以外の場合は false。
        /// </returns>
