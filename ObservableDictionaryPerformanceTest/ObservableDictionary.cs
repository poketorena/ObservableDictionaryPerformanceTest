...
{
    /// <summary>
    ///   項目が追加または削除されたとき、あるいはリスト全体が更新されたときに通知を行う動的なキーと値のコレクションを表します。
    /// </summary>
        ...
        : CollectionBasedDictionary<TKey, TValue>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2" /> クラスの
        ///   新しいインスタンスを初期化します。
        /// </summary>
        ...
        ///   新しい <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2" /> に要素がコピーされた 
        ...
        /// <summary>
        ///   指定された引数を使用して、
        ///   <see cref="E:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2.PropertyChanged" /> イベントを発生させます。
        /// </summary>
        ...
        /// <summary>
        ///   指定された引数を使用して、
        ///   <see cref="E:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2.CollectionChanged" /> イベントを発生させます。
        /// </summary>
        ...
        /// <summary>
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2" /> 内の指定したインデックスの位置に要素を挿入します。
        /// </summary>
        /// <param name="index">
        ...
        ///   または<paramref name="index" /> が <see cref="P:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2Count" /> より大きくなっています。
        /// </exception>
        ...
        /// <summary>
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2" /> の指定したインデックスにある要素を削除します。
        /// </summary>
        ...
        /// <summary>
        ///   <see cref="T:ObservableDictionaryPerformanceTest.Collections.Generic.ObservableDictionary`2" /> からすべての要素を削除します。
        /// </summary>
